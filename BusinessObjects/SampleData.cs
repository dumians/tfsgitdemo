    ...
    public static class SampleDataStore
    {
        ...
        {   
            ...
            {   
                while (fromDate <= toDate)
                {   
                    Int32 luckyNumber = rand.Next(2, (Int32) (100* count));

                    Int32 numberOfLicenseSoldToday = (Int32)(luckyNumber * 0.123 * rand.NextDouble() * rand.NextDouble());

                    Random rand2 = new Random(numberOfLicenseSoldToday);
                    numberOfLicenseSoldToday = rand2.Next(0, numberOfLicenseSoldToday);
                    ...
                    while (index >= 0)
                    {
                        ...
                        Int32 value = rand.Next(index, index + rand.Next(0, 10));
                        isNewLicense = value == 3 || value == 5;
